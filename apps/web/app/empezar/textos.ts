...
const es = {
  ...
  lede1: 'Elige cómo empezar, completa tus datos y en pocos minutos tendrás tu página', lede2: 'con entradas, cobro directo y control de acceso.',
  elige: 'Elige cómo empezar',
  prueba: 'Prueba gratuita', pruebaDet: (tope: number) => `1 evento de hasta ${tope} entradas. Sin tarjeta.`,
  evento: 'evento', eventos: 'eventos', puntual: 'Para un evento puntual.', porEvento: 'por evento',
  masElegido: 'El más elegido', gratis: 'Gratis',
  ...
  incluido: 'Todas las opciones incluyen tu página con tu logo, entradas con QR, cobro directo a tu cuenta, escáner de acceso y panel de gestión.', sinComision: 'Sin comisión por entrada.',
  tuMarca: 'Tu marca',
  ...
  correo: 'Tu correo', correoPh: 'tu@correo.com', correoHint: 'Recibirás aquí el código y los avisos de pago.',
  ...
  enviarCodigo: 'Enviarme el código', pagar: (p: string) => `Pagar ${p}`, momento: 'Un momento…',
  finoPrueba: 'Te enviaremos un código por correo para confirmar que es tuyo.',
  ...
  revisa: 'Revisa tu correo', enviamos: 'Te enviamos un código de 8 dígitos a', spam: 'Si no lo encuentras, revisa las carpetas de spam o promociones.',
  codigo: 'Código', vence: 'Vence en una hora.', crear: 'Crear mi marca',
  finoCodigo: (tope: number) => `Ingresarás a tu panel con tu evento de prueba: hasta ${tope} entradas.`,
  cambiar: 'Modificar mis datos', reenviar: 'Reenviar código', reenviarEn: (s: number) => `Reenviar código en ${s} s`,
  tuPlan: 'Tu plan', pagoUnico: 'pago único', pruebaResumen: (tope: number) => `1 evento de hasta ${tope} entradas`,
  ...
  m: {
    ...
    pronto: 'Este medio de pago estará disponible muy pronto. Mientras tanto, puedes comenzar con la prueba gratuita.',
    ...
    tomadoRecien: 'Ese enlace fue tomado por otra marca hace un momento. Elige otro para continuar.',
    noCodigo: 'No pudimos enviarte el código. Inténtalo nuevamente en unos minutos.',
    escribeCodigo: 'Escribe el código que recibiste.', codigoMal: 'El código no coincide o ya venció. Revisa el último que recibiste.',
    noCuenta: 'No pudimos terminar de crear tu cuenta. Solicita un código nuevo e inténtalo otra vez.',
    noMarca: 'No pudimos crear tu marca. Inténtalo nuevamente en un momento.',
...
const en: T = {
  ...
  lede1: 'Choose how to start, complete your details and in a few minutes you will have your page', lede2: 'with tickets, direct payments and entry control.',
  elige: 'Choose how to start',
  prueba: 'Free trial', pruebaDet: (tope) => `One event with up to ${tope} tickets. No card required.`,
  evento: 'event', eventos: 'events', puntual: 'For a one-off event.', porEvento: 'per event',
  masElegido: 'Most popular', gratis: 'Free',
  ...
  incluido: 'Every option includes your own branded page, QR tickets, direct payments to your account, an entry scanner and a management dashboard.', sinComision: 'No per-ticket fees.',
  tuMarca: 'Your brand',
  ...
  correo: 'Your email', correoPh: 'you@email.com', correoHint: 'You will receive your code and payment alerts here.',
  ...
  enviarCodigo: 'Send me the code', pagar: (p) => `Pay ${p}`, momento: 'One moment…',
  finoPrueba: 'We will email you a code to confirm the address is yours.',
  ...
  revisa: 'Check your email', enviamos: 'We sent an 8-digit code to', spam: 'If you cannot find it, check your spam or promotions folders.',
  codigo: 'Code', vence: 'It expires in one hour.', crear: 'Create my brand',
  finoCodigo: (tope) => `You will enter your dashboard with your trial event: up to ${tope} tickets.`,
  cambiar: 'Edit my details', reenviar: 'Resend code', reenviarEn: (s) => `Resend code in ${s}s`,
  tuPlan: 'Your plan', pagoUnico: 'one-time payment', pruebaResumen: (tope) => `One event with up to ${tope} tickets`,
  ...
  m: {
    ...
    pronto: 'This payment method will be available very soon. In the meantime, you can start with the free trial.',
    ...
    tomadoRecien: 'That link was just taken by another brand. Choose another one to continue.',
    noCodigo: 'We could not send your code. Please try again in a few minutes.',
    escribeCodigo: 'Enter the code you received.', codigoMal: 'The code does not match or has expired. Check the latest one you received.',
    noCuenta: 'We could not finish creating your account. Request a new code and try again.',
    noMarca: 'We could not create your brand. Please try again in a moment.',
