  ...
  return (
    <>
      <div style={{ marginBottom: 14 }}>
        ...
        <p className="s-card__desc">El precio de los que ya compraron queda congelado. Podés subir capacidad y crear tipos nuevos.</p>
      </div>
      ...
      <div className="s-stack" style={{ gap: 10 }}>
        {rows.length === 0
          ...
          : rows.map((t) => <div key={t.id} className="s-card"><TicketTypeEditor eventId={event.id} tt={t} /></div>)}
      </div>
